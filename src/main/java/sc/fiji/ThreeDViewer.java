...
public class ThreeDViewer extends SceneryDefaultApplication {
	...
	{	
		...
		/*
		try {
			ij.ui().show( ij.scifio().datasetIO().open( "/Users/kharrington/Dropbox/a1Selfshare/A_elephantConv/Cute_Little_Elephant_voxelization.tif" ) );
		} catch (IOException e) {
	...
	public static void addChild(Node n) {
		viewer.getScene().addChild( n );
	}
}
